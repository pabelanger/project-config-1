    ...
    def process_acls(self, acl_config, repo):
        ...
        for entry in config:
            ...
            if entry.get('required_status_checks', []).get('contexts'):
                kwargs['contexts'] = entry.get('required_status_checks', []).get('contexts')
            ...
            _status_checks = branch_protection.required_status_checks
            if _status_checks and kwargs['contexts'] == _status_checks.contexts:
                del kwargs['contexts']
